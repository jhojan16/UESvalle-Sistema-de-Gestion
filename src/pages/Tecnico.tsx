...
export default function Tecnicos() {
  ...
  const { data: tecnicos, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      if (search) {
        query = query.or(
          `nombre.ilike.%${search}%,profesion.ilike.%${search}%`,
        );
      }
  ...
  const preparePayload = (data: typeof formData) => ({
    ...
    id_ubicacion_tec: data.id_ubicacion_tec
      ? parseInt(data.id_ubicacion_tec)
      : null,
  ...
  return (
    <Box>
          ...
          <DialogContent dividers>
            ...
            >
              ...
              <TextField
                ...
                onChange={(e) =>
                  setFormData({ ...formData, id_laboratorio: e.target.value })
                }
              >
                <option value=""></option>
              ...
              <TextField
                ...
                onChange={(e) =>
                  setFormData({ ...formData, id_ubicacion_tec: e.target.value })
                }
              >
                <option value=""></option>
                {ubicaciones?.map((u) => (
                  <option key={u.id_ubicacion_tec} value={u.id_ubicacion_tec}>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Esta acción no se puede deshacer. El técnico será removido
